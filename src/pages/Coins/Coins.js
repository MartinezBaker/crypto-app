          ...
          <TableParent>
            <TableContainer>
              ...
              <InfiniteScroll
                ...
                loader={
                  (this.state.isLoading && <StyledMessage>Loading...</StyledMessage>) || (
                    <StyledMessage>{this.state.errMessage}</StyledMessage>
                  )
                }
              >
                <Table>
                  ...
                  <tbody>
                    {(coinList.length &&
                      ...
                      <StyledMessage>this.props.errMessage</StyledMessage>}
                  </tbody>
                </Table>
              </InfiniteScroll>
            </TableContainer>
